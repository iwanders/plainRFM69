...
/*
    This example shows the buffering in action.
*/
...
void receiver(){
    ...
    while(true){
        ...
        if (rfm.available()){
            Serial.println("Oh look, there are packets!");
        }
        uint8_t packets = 0;
        ...
        if (packets > 0){
            Serial.print("We had "); Serial.print(packets); Serial.println(" packets in the buffer.\n");
        }
    }
}
